...
Another important feature of linux is the ability to create links to files. These links are called symbolic links, and they act like shortcuts. These are very useful in bioinformatics. We might use a symbolic link to point to a directory containing reference files that might be buried deep in the file system. We create symbolic links use the `ln` command